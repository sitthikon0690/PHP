...
<form method="post" action="8.2.php" enctype="multipart/form-data">
Name 
...
Salary
<input type="number" name="salary"> bath <br></br>
...
Experience <br>
<textarea name="Experience" rows="10" cols="60"></textarea><br></br>
